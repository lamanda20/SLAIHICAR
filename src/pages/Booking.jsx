...
const Booking = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        alert("Réservation enregistrée ! Nous vous contacterons sous 24h pour finaliser votre location.");
    };
                            ...
                            <div className="booking__form">
                                ...
                                <Form onSubmit={handleSubmit}>
                                    ...
                                    <div className="form__section">
                                        <h5 className="section__heading">Informations Personnelles</h5>
                                        <Row>
                                            <Col md="6">
                                                <FormGroup>
                                    ...
                                    {/* Dates et horaires */}
                                    <div className="form__section">
                                        <h5 className="section__heading">Dates et Horaires de Location</h5>
                                        <Row>
                                            <Col md="6">
                                                <FormGroup>
                                                    <Label for="datePickup">Date de prise en charge *</Label>
                                                    <Input
                                                        type="date"
                                                        name="datePickup"
                                                        id="datePickup"
                                            ...
                                            <Col md="6">
                                                <FormGroup>
                                                    <Label for="timePickup">Heure de prise en charge *</Label>
                                                    <Input
                                                        type="time"
                                                        name="timePickup"
                                                        id="timePickup"
                                    ...
                                    {/* Permis de conduire */}
                                    <div className="form__section">
                                        <h5 className="section__heading">Permis de Conduire</h5>
                                        <FormGroup>
                                            <Label for="driverLicense">Numéro de permis *</Label>
                                            <Input
                                                type="text"
                                                name="driverLicense"
                                                id="driverLicense"
                                    ...
                                    {/* Demandes spéciales */}
                                    <div className="form__section">
                                        <h5 className="section__heading">Demandes Spéciales (Optionnel)</h5>
                                        <FormGroup>
                        ...
                        <Col lg="4" md="12">
                            <div className="booking__summary">
                                ...
                                <div className="car__summary">
                                    {carImage && (
                                        <img src={carImage} alt={car.carName} className="summary__car-img" />
                                    )}
